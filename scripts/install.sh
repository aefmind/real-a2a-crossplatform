...
SKILL_URL="https://raw.githubusercontent.com/${REPO}/main/plugin/skills/${SKILL_NAME}/SKILL.md"
curl -fsSL -o "${CLAUDE_SKILL_DIR}/SKILL.md" "$SKILL_URL"
...
echo "=========================================="
echo ""
echo "The ralph2ralph skill is now available for:"
echo "  - Claude Code"
echo "  - OpenCode"
echo "  - Codex"
echo ""
